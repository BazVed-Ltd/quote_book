defmodule QuoteBookWeb.UserAuthTest do
  use QuoteBookWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias QuoteBook.Accounts
  alias QuoteBookWeb.UserAuth
  import QuoteBook.AccountsFixtures

  @remember_me_cookie "_quote_book_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, QuoteBookWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      QuoteBookWeb.Endpoint.subscribe(live_socket_id)
