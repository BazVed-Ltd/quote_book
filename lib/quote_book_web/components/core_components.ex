defmodule QuoteBookWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(QuoteBookWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(QuoteBookWeb.Gettext, "errors", msg, opts)
    end
  end
